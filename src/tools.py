...
def registrar_herramientas(mcp):
    mcp.tool()(listar_stored_procedures)
    mcp.tool()(obtener_definicion_sp)
    mcp.tool()(obtener_columnas_tabla)
    mcp.tool()(obtener_indices_tabla)
    mcp.tool()(ejecutar_consulta_segura)
